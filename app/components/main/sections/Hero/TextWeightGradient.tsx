    ...
    >
      <div className="w-fit h-fit p-2 relative">
        ...
        <div
          ...
          className="text-[2.5rem] xs:text-6xl sm:text-7xl md:text-8xl lg:text-[9rem] 2xl:text-[12rem] font-yapari text-center text-white cursor-default select-none whitespace-nowrap flex"
          aria-label={text}
